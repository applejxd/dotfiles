...
| [0004](0004-opencode-sandbox.md) | OpenCode の保護を OS のアクセス制御へ移す（Ubuntu / WSL のみ） | In progress | **判断待ちなしの項目は尽きた**。資格情報が境界内から読める件（方針 + 実機確認）と `service.json` の読み取りが残る | 資格情報の扱いを決める | 2026-09-24 |
