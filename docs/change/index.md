...
| --- | --- | --- | --- | --- | --- |
| [0001](0001-compaction-context-handover.md) | compaction を跨いで作業文脈を失わない | In progress | **注入が効くことを実測済み**（返答が指定どおりに変わった）。残るは `compaction` フックの発火確認だけ | 長い会話または `/compact` での発火確認（TUI が要る） | 2026-09-24 |
