...
| --- | --- | --- | --- | --- | --- |
| [0001](0001-compaction-context-handover.md) | compaction を跨いで作業文脈を失わない | In progress | **OpenCode 専用に方針転換**。スキルを `~/.config/opencode/skills` へ移した。`compaction` フックは自動・手動で経路が分かれないことを静的に確認 | hook 層 3 本の去就（撤去 or plugin 化） | 2026-09-24 |
