...
| 文書 | 内容 |
| --- | --- |
| [プロジェクト構造](structure.md) | ディレクトリ構成、chezmoiスクリプトの順序、対応OS、gh / Herdr / AI CLIのmise管理 |
...
| [エージェント権限仕様](agent-permissions.md) | Claude Code / Copilot CLI中心のpermissionと、各CLIへのhook生成 |
