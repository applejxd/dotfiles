...
| [0004](0004-opencode-sandbox.md) | OpenCode の保護を OS のアクセス制御へ移す（Ubuntu / WSL のみ） | In progress | 事前確認は全て決着。固定費 44 ms でゲート通過。対処後の自動化率は 98.7% の見込み | 段階 1（chezmoi を snap から外す） | 2026-09-22 |
